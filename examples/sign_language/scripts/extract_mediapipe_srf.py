...
def extract_poses(vid_file: Path, new_fps: int):
    ...
    #Only necessary to change the scaling for SRF, as it is scaled between 0 and 1.
    # width = 640
    # height = 720
    # print("Before", poses.body.data)
    # poses.body.data = poses.body.data * np.array([width, height, 1.0])
    # print("After", poses.body.data)
    return poses
